...
g_dashboard_get_info1_dict = {'system_time': '0000年00月00日 星期五 00:00', 'device_id': '00', 'run_status': "<i class='fa fa-circle red'> 运行中", ' run_time': '243', 'record_interval': '1', 'update_time': '更新于: 0000-0-0 00:00:00', 'temp_1': '35.4', 'hum_1': '61.7',  'control_mode_1': "自动 <i class='glyphicon glyphicon-transfer'></i>", 'control_method_1': "节能 <i class='glyphicon gl yphicon-leaf'></i>", 'temp_status_info_1': "制冷 <i class='glyphicon glyphicon-asterisk'></i>", 'humi_status_info_1': " 加湿 <i class='glyphicon glyphicon-tint'></i>", 'target_temp_1': '16.0', 'control_temp_1': '0.5', 'target_hum_1': '90.0' , 'control_hum_1': '9.0', 'temp_2': '--', 'hum_2': '--', 'control_mode_2': 'hide', 'control_method_2': 'hide', 'temp_sta tus_info_2': '', 'humi_status_info_2': '', 'target_temp_2': '20.0', 'control_temp_2': '1.0', 'target_hum_2': '96.0', 'co ntrol_hum_2': '5.0', 'temp_3': '36.0', 'hum_3': '51.0', 'control_mode_3': "自动 <i class='glyphicon glyphicon-transfer'> </i>", 'control_method_3': 'hide', 'temp_status_info_3': "制冷 <i class='glyphicon glyphicon-asterisk'></i>", 'humi_stat us_info_3': "加湿 <i class='glyphicon glyphicon-tint'></i>", 'target_temp_3': '20.0', 'control_temp_3': '1.0', 'target_h um_3': '96.0', 'control_hum_3': '5.0', 'temp_4': '--', 'hum_4': '--', 'control_mode_4': 'hide', 'control_method_4': 'hid e', 'temp_status_info_4': '', 'humi_status_info_4': '', 'target_temp_4': '20.0', 'control_temp_4': '3.0', 'target_hum_4' : '97.8', 'control_hum_4': '5.1', 'temp_5': '35.7', 'hum_5': '56.3', 'control_mode_5': "自动 <i class='glyphicon glyphic on-transfer'></i>", 'control_method_5': "节能 <i class='glyphicon glyphicon-leaf'></i>", 'accm_1': "<i class='fa fa-circ le accm1'></i>", 'accm_2': "<i class='fa fa-circle accm2'></i>", 'accm_3': "<i class='fa fa-circle accm2'></i>", 'accm_4 ': "<i class='fa fa-circle accm2'></i>", 'temp_status_info_5': "制冷 <i class='glyphicon glyphicon-asterisk'></i>", 'hum i_status_info_5': "加湿 <i class='glyphicon glyphicon-tint'></i>", 'target_temp_5': '16.0', 'control_temp_5': '0.5', 'target_hum_5': '90.0', 'control_hum_5': '9.0'}
...
def get_inst_data():
    ...
    per_page = 25
    inst_data = InstData.sort_values(by='record_time', ascending=False).query.paginate(page=page, per_page=per_page, error_out=False)  
